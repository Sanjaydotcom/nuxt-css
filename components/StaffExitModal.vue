      ...
      >
        <div>
         ...
         Staff Exit 
                ...
                <div class="grid grid-cols-12   pt-4 gap-2">
                  ...
                  <div class="col-span-12">
                    ...
                    >
                     <input
                      ...
                      name="last-name"
                      id="last-name"
                      placeholder="Exit Interview Date"
                      autocomplete="family-name"
                      class="
                        mt-1
                        focus:ring-indigo-400 focus:border-indigo-400
                  ...
                  <div class="col-span-6">
                    ...
                    >
                   <textarea rows="3" name="comment" id="comment" class="shadow-sm focus:ring-indigo-400 focus:border-indigo-400 block w-full sm:text-sm border-gray-300 rounded-md"></textarea>
                  </div>
