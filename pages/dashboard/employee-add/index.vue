<template>
  <div class="container mx-auto px-2 py-2">
    ...
    -->
        <div class="pt-1.5">
          <h1 class="text-2xl font-bold text-gray-900">Employee</h1>
          <p class="text-sm font-medium text-gray-500">EMP1234</p>
        </div>
      </div>
      <div
        class="
      ...
      >
        ...
        <select id="country" name="Gender" autocomplete="country-name" class="
              border border-gray-300
              bg-white
              rounded-md
              shadow-sm
              focus:outline-none focus:ring-indigo-500 focus:border-indigo-500
              sm:text-sm leading-4 font-medium rounded-md text-gray-700 " style="border-width: 0.25px;"><option>Actions</option> <option>Appraisal</option> <option>Staff Exit</option></select>
      </div>
    </div>
    <div class="pt-3">
      <div class="sm:hidden">
          ...
          <nav class="-mb-px flex space-x-8" aria-label="Tabs">
            ...
            <a
              ...
              class="
                ...
                text-sm
              "
              :class="visibleTabName == 'general' ? 'border-indigo-500' : ''"
            ...
            <a
              ...
              class="
                ...
                text-sm
              "
              :class="visibleTabName == 'assets' ? 'border-indigo-500' : ''"
            ...
            <a
              ...
              class="
                ...
                text-sm
              "
              :class="visibleTabName == 'appraisal' ? 'border-indigo-500' : ''"
